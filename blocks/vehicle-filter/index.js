(function( wp ) {
    ...
    registerBlockType( 'bihr/vehicle-filter', {
        edit: function( props ) {
            ...
            return el( 'div', {},
                ...
                el( 'div', { className: 'bihr-block-placeholder', style: {
                    ...
                    el( 'h3', {}, __( 'Filtre Véhicule BIHR', 'bihr-synch' ) ),
                    el( 'p', { style: { color: '#666' } }, attributes.title ),
                    el( 'p', { style: { fontSize: '12px', color: '#999' } }, __( 'Ce bloc affiche le filtre de compatibilité véhicule en frontend.', 'bihr-synch' ) ),
                )
            );
        },
        save: function() {
