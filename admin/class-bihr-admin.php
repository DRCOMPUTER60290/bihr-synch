...
class BihrWI_Admin {
    ...
    public function register_menus() {
        ...
        add_menu_page(
            __( 'BIHR WooCommerce', 'bihr-synch' ),
            __( 'BIHR', 'bihr-synch' ),
            'manage_woocommerce',
            'bihr-dashboard',
        ...
        add_submenu_page(
            'bihr-dashboard',
            __( 'Dashboard BIHR', 'bihr-synch' ),
            __( '🏠 Accueil', 'bihr-synch' ),
            'manage_woocommerce',
            'bihr-dashboard',
            array( $this, 'render_dashboard_page' )
        );
        ...
        add_submenu_page(
            'bihr-dashboard',
            __( 'Authentification Bihr', 'bihr-synch' ),
            __( '🔐 Authentification', 'bihr-synch' ),
            'manage_woocommerce',
            'bihr-auth',
        ...
        add_submenu_page(
            'bihr-dashboard',
            __( 'Paramètres Commandes', 'bihr-synch' ),
            __( '🛒 Commandes', 'bihr-synch' ),
            'manage_woocommerce',
            'bihr-orders',
        ...
        add_submenu_page(
            'bihr-dashboard',
            __( 'Gestion des marges', 'bihr-synch' ),
            __( '💰 Marges', 'bihr-synch' ),
            'manage_woocommerce',
            'bihr-margins',
        ...
        add_submenu_page(
            'bihr-dashboard',
            __( 'Produits Importés', 'bihr-synch' ),
            __( '✅ Produits Importés', 'bihr-synch' ),
            'manage_woocommerce',
        ...
        add_submenu_page(
            'bihr-dashboard',
            __( 'Compatibilité Véhicules', 'bihr-synch' ),
            __( '🚗 Compatibilité', 'bihr-synch' ),
            'manage_woocommerce',
            'bihr-compatibility',
        ...
        add_submenu_page(
            'bihr-dashboard',
            __( 'Synchronisation SKU (Compatibilité)', 'bihr-synch' ),
            __( '🔄 Synchro SKU', 'bihr-synch' ),
            'manage_woocommerce',
    ...
    public function render_products_page() {
        ...
        if ( ! current_user_can( 'manage_woocommerce' ) ) {
            wp_die( esc_html__( 'Vous n\'avez pas les permissions nécessaires pour accéder à cette page.', 'bihr-synch' ) );
        }
        ...
        if ( isset( $_GET['bihrwi_filter_nonce_field'] ) ) {
            if ( ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['bihrwi_filter_nonce_field'] ) ), 'bihrwi_filter_nonce' ) ) {
                wp_die( esc_html__( 'Erreur de sécurité. Veuillez réessayer.', 'bihr-synch' ) );
            }
        }
...
include BIHRWI_PLUGIN_DIR . 'admin/views/products-page.php';
    ...
    $wpdb->query( $wpdb->prepare( "TRUNCATE TABLE {$wpdb->prefix}bihr_products" ) );
