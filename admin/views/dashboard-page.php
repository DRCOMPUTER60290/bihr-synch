...
<div class="wrap bihr-dashboard">
    ...
    <div class="bihr-header">
        <h1>🚀 <?php esc_html_e( 'BIHR WooCommerce Importer', 'bihr-importer' ); ?></h1>
    ...
    <div class="bihr-status-cards">
        ...
        <div class="status-card <?php echo $is_authenticated ? 'status-ok' : 'status-warning'; ?>">
            ...
            <div class="status-content">
                <h3><?php esc_html_e( 'Authentification', 'bihr-importer' ); ?></h3>
                <p>
                    <?php 
                    if ( $is_authenticated ) {
                        esc_html_e( 'Connecté à l\'API BIHR', 'bihr-importer' );
                    } else {
                        esc_html_e( 'Non connecté', 'bihr-importer' );
                    }
                    ?>
                </p>
            </div>
        ...
        <div class="beginner-steps">
            ...
            <div class="step-card step-1 <?php echo $is_authenticated ? 'step-completed' : 'step-active'; ?>">
                ...
                <div class="step-content">
                    <h3><?php esc_html_e( 'Se connecter à BIHR', 'bihr-importer' ); ?></h3>
                    <p><?php esc_html_e( 'Authentifiez-vous avec vos identifiants BIHR pour accéder à vos produits.', 'bihr-importer' ); ?></p>
                    <?php if ( ! $is_authenticated ) : ?>
                    <a href="<?php echo esc_url( add_query_arg( 'page', 'bihr-auth', admin_url( 'admin.php' ) ) ); ?>" class="button button-primary">
                        🔐 <?php esc_html_e( 'Se connecter', 'bihr-importer' ); ?>
                    </a>
                    <?php else : ?>
                    <a class="button button-success" aria-disabled="true">✅ <?php esc_html_e( 'Connecté', 'bihr-importer' ); ?></a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="step-card step-2 <?php echo $is_authenticated ? 'step-active' : ''; ?>">
                ...
                <div class="step-content">
                    <h3><?php esc_html_e( 'Importer les produits', 'bihr-importer' ); ?></h3>
                    <p><?php esc_html_e( 'Téléchargez le catalogue BIHR dans WooCommerce en quelques clics.', 'bihr-importer' ); ?></p>
                    <a href="<?php echo esc_url( add_query_arg( 'page', 'bihr-products', admin_url( 'admin.php' ) ) ); ?>" class="button button-secondary" <?php echo ! $is_authenticated ? 'disabled' : ''; ?>>
                        📥 <?php esc_html_e( 'Importer', 'bihr-importer' ); ?>
                    </a>
                </div>
            </div>
            ...
            <div class="step-card step-3">
                ...
                <div class="step-content">
                    <h3><?php esc_html_e( 'Configurer les synchronisations', 'bihr-importer' ); ?></h3>
                    <p><?php esc_html_e( 'Activez la synchronisation automatique des stocks et commandes.', 'bihr-importer' ); ?></p>
                    <a href="<?php echo esc_url( add_query_arg( 'page', 'bihr-orders', admin_url( 'admin.php' ) ) ); ?>" class="button button-secondary">
                        ⚙️ <?php esc_html_e( 'Configurer', 'bihr-importer' ); ?>
                    </a>
                </div>
            </div>
        </div>
